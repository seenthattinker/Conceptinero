...
tools,
and management.
The tool set is Drupal&trade; 7 with custom extensions.
InSite Event&trade; platform presented the uncertainties which necessitated research and experimental development.


ASYNCHRONOUS TO SYNCHRONOUS

InSite borrowed from our `asynchronous` portal and incorporated it into its `synchronous` functioning,
...
We extended our custom Drupal module to allow for the upload custom icon and graphics.
